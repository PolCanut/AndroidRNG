...
fun Welcome(
    ...
    goToGameResult: (Long) -> Unit, // Función para iniciar el juego
    goToHelp: () -> Unit,
    goToLogin: () -> Unit,
    goToBestGames: () -> Unit,
    ...
    val bestGameResultState = viewModel.bestGameResultState.collectAsState().value
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = {
                    Firebase.auth.signOut() // TODO improve this
                    goToLogin()
                },
                modifier = Modifier.width(BUTTONS_WIDTH.dp),
            ) {
            ...
            Button(
                ...
                Text(stringResource(R.string.best_games))
            }
            ...
            if (bestGameResultState is BestGameResultState.PlayerIsBest) {
                OutlinedButton(
                    modifier = Modifier.padding(bottom = 16.dp),
                    onClick = {
                        val id = bestGameResultState.gameResult.id
                    ...
                    Text(
                        stringResource(R.string.best_player),
                    )
                }
            }
