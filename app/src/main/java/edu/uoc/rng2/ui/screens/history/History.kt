...
fun History(
    ...
    Scaffold(
        ...
        topBar = {
            ...
            TopAppBar(
                title = {
                    Text(stringResource(id = R.string.history)) // Título de la barra superior.
                },
                navigationIcon = {
        ...
        if (gameResults.isEmpty()) {
            ...
            Column(
                ...
                Text(stringResource(R.string.empty_history))  // Mensaje indicando que el historial está vacío.
            }
        } else {
